...
Look for issues labeled [`good first issue`](https://github.com/soumyachk101/GitCity/labels/good%20first%20issue). These are scoped tasks that don't require deep knowledge of the codebase.
